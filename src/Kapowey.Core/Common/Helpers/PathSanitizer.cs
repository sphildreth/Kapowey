...
namespace Kapowey.Core.Common.Helpers
{
    ...
    public static class PathSanitizer
    {
        ...
        public static string SanitizeFilename(string input, char errorChar) => Sanitize(input, invalidFilenameChars, errorChar);
        ...
        /// <param name="input">the string to clean</param>
        /// <param name="errorChar">the character which replaces bad characters</param>
        public static string SanitizePath(string input, char errorChar) => Sanitize(input, invalidPathChars, errorChar);
